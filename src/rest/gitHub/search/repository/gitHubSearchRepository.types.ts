...
export type GitHubSearchQualifiersRepository = {
   ...
   * ```
   */
  stars?: GitHubSearchNumberParam;
  /**format: YYYY-MM-DD
   * operators such as >, >=, <, <=  and .. can be used eg:
   * ```
   * ">=2022.05.06"
   ...
   * ```
   */
  topics?: GitHubSearchNumberParam;
  license?: string;
  /**format: string of integer
   * operators such as >, >=, <, <=  and .. can be used
   * ```
   ...
   * ```
   */
  "good-first-issues"?: GitHubSearchNumberParam;
  /**format: string of integer
   * operators such as >, >=, <, <=  and .. can be used
   * ```
   * ">=20"
   ...
   * ```
   */
  "help-wanted-issues"?: GitHubSearchNumberParam;
};
