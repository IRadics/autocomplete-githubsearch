...
import {
  GitHubSearchQualifiersRepository,
  GitHubSearchSortRepository,
  RepoSearchResult,
  GitHubSearchOrderRepository,
} from "../repository/gitHubSearchRepository.types";
 ...
 */
async function gitHubSearchRepository(
  query: string,
  qualifiers?: GitHubSearchQualifiersRepository,
  sort?: GitHubSearchSortRepository,
  order?: GitHubSearchOrderRepository,
  pagination?: GitHubSearchPaginationSettings,
  callbackSuccess?: (result: RepoSearchResult) => void,
  ...
  let data: RepoSearchResult = {} as RepoSearchResult;
